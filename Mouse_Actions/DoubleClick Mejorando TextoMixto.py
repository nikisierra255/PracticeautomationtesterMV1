...
class Base_Test(unittest.TestCase):
    ...
    def test1(self):
        ...
        f.Texto_mixto("xpath","//input[contains(@id,'user-name')]","Admin",2)
        f.Texto_mixto("xpath","//input[contains(@id,'password')]","admin",2)
        f.Click_mixto("xpath","//input[contains(@id,'login-button')]",1)
